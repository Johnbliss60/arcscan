...
var ICONS = {
  add: async () => (await import("./add-UY336WTC.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-IRFOWU2Q.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-WFZDOADZ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-B3VNBRHO.js")).appStoreSvg,
  apple: async () => (await import("./apple-6L3DHYXR.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-Q6CYVJNI.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-H352DY3T.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-QFW5ZVS2.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-THZ6PGW4.js")).arrowTopSvg,
  bank: async () => (await import("./bank-GE743T4C.js")).bankSvg,
  browser: async () => (await import("./browser-LGKAPOFJ.js")).browserSvg,
  card: async () => (await import("./card-6EHCSKNW.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-WBQJ5NRM.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-GZ4GFDQE.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-DX3TKHGN.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-GFX6RQSM.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-76KWUZCC.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-KBB725ZI.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-QCY6SNGM.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-LA6C7NFY.js")).clockSvg,
  close: async () => (await import("./close-SV5X4HMC.js")).closeSvg,
  compass: async () => (await import("./compass-3DLGCMLL.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-55WWWHJI.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-HF23HHZT.js")).copySvg,
  cursor: async () => (await import("./cursor-KIGAWFOZ.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-W6KUDXKE.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-D3XX5QXK.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-3TZKXYH6.js")).disconnectSvg,
  discord: async () => (await import("./discord-AUCEWQ6F.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-C6O2U6JO.js")).etherscanSvg,
  extension: async () => (await import("./extension-PHSLDHT6.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-YXVWHBXO.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-PCM7NOXF.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-HU2KA3NL.js")).farcasterSvg,
  filters: async () => (await import("./filters-OHGTLCPG.js")).filtersSvg,
  github: async () => (await import("./github-SRGTZEK2.js")).githubSvg,
  google: async () => (await import("./google-Y5VOPV5Y.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-32MAXTEG.js")).helpCircleSvg,
  image: async () => (await import("./image-44CN7NBU.js")).imageSvg,
  id: async () => (await import("./id-PG4QLK4H.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-QXR4TKPB.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-UT3L64LH.js")).lightbulbSvg,
  mail: async () => (await import("./mail-LIRDEK72.js")).mailSvg,
  mobile: async () => (await import("./mobile-Y5R3V7ER.js")).mobileSvg,
  more: async () => (await import("./more-PJ6SCOEC.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-YBUPNUD6.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-2XORC6VX.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-RUUCY7QL.js")).offSvg,
  playStore: async () => (await import("./play-store-UDR226Z2.js")).playStoreSvg,
  plus: async () => (await import("./plus-EP5TOB6A.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-YFS4HM6M.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-LXXGDOZP.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-OSMOAOED.js")).refreshSvg,
  search: async () => (await import("./search-IPP7KVJO.js")).searchSvg,
  send: async () => (await import("./send-QIVMMHPH.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-YXVSJWLK.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-6LCMY27B.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-PQZPFRLR.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-UYYSBGCG.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-JXMPM6CH.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-NHAYOL5Q.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-CRYPWAHF.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-I7RKVTS6.js")).twitchSvg,
  twitter: async () => (await import("./x-J4TMSF4T.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-CID2CQRJ.js")).twitterIconSvg,
  verify: async () => (await import("./verify-UHKJK2NM.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-NRDTIT3N.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-ABWKHALW.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-P2UB27TR.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-P2UB27TR.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-P2UB27TR.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-IP5TTYTC.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-V4UPX6WU.js")).warningCircleSvg,
  x: async () => (await import("./x-J4TMSF4T.js")).xSvg,
  info: async () => (await import("./info-WW7NL4DR.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-3MRUIPGO.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-3SIYPDF7.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OFULNWK6.js.map
