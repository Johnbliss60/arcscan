  ...
  block: defineBlock({
    format(args) {
      ...
      const transactions = (_a2 = args.transactions) == null ? void 0 : _a2.map((transaction) => {
        ...
        if (typeof transaction === "string")
          return transaction;
        const formatted = (_a3 = formatters3.transaction) == null ? void 0 : _a3.format(transaction);
...
function from11(envelope, options = {}) {
  ...
  return {
    ...
    ...feePayerSignature ? { feePayerSignature: from5(feePayerSignature) } : {},
    type: "tempo"
  };
}
...
async function serializeTempo(transaction, sig) {
  ...
  if (signature && typeof transaction.feePayer === "object") {
    ...
    return TxEnvelopeTempo_exports.serialize(tx, {
      feePayerSignature: from5(feePayerSignature2)
    });
  }
  if (feePayer === true) {
    if (signature)
...
//# sourceMappingURL=chunk-CLIVZNSO.js.map
